package net.zombiex.industryrefined.screen;
...
public class RefineryMenu extends AbstractContainerMenu {
    ...
    public RefineryMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER.ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 30, 11));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 30, 58));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 70, 58));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 110, 11));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 110, 58));
        }));
    ...
    protected RefineryMenu(@Nullable MenuType<?> pMenuType, int pContainerId) {
