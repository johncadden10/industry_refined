package net.zombiex.industryrefined;
...
@Mod(IndustryRefined.MOD_ID)
public class IndustryRefined {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "industryrefined";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public IndustryRefined(FMLJavaModLoadingContext context) {
